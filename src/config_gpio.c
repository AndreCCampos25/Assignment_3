/** @file config_gpio.c
 * @brief Configuração dos botões. 
 * 
 *
 * São declaradas e inicializadas as variáveis e estruturas necessárias para 
 * a utilização dos botões. São também definidas as funções que possibilitam
 * a geração de eventos quando um botão é pressionado.
 * 
 * 
 * @authors 
 *	Denys Zadorozhnyy\n
